 ...
 */
var q1= [1,2,3,4];
q1.forEach(function(num, index){
	q1[index] = num + 1
	// console.log('num: ' + num + ' | index: ' + index)
});

// comsole.log('New numbers: ' + numbers);
...
q2.forEach(function(name) {
	$('.class-list').append('<li>' + name + '</li>');
});
/**
 * Question 3
 * Using the array from Question 1, find the average of the numbers in the array 
 (average=sum of all numbers/number of numbers). Store the average in q3.
 */
 
 var sum = 0;
 var numberOfItems = q1.length
 q1.forEach(function(num) {sum += num});
