...
/**
 * Question 2:
 * When button 1 is clicked, select all <h2> elements on this page, and 
 change the text to say your name.
 */

/**
 * Question 3:
 * When button 1 is clicked, select the ordered list item that has the 
 class "falseFact". 
...
/**
 * Question 4: 
 * When button 2 is clicked, change the background color of the 
   whole page to "pink"
 */
...
/**
 * Question 7:
 * When button 3 is clicked, change the text in the header's h1 tag 
 to read "jQuery Ninja"
 */
